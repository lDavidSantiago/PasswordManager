...
# This function is used to hash the master password provided by the user

def hash_password(password):  
    sha256 = hashlib.sha256()
    # hashlib.sha256() initializes a new SHA-256 hash object
    sha256.update(password.encode())
    # password.encode() converts the password string into bytes, 
    # so it can be hashed by sha256.update()
    return sha256.hexdigest()
    # sha256.hexdigest() returns the hexadecimal representation of the SHA-256 hash
